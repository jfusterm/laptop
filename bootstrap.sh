...
TERRAFORM_VERSION=${TERRAFORM_VERSION:-0.13.0}
PACKER_VERSION=${PACKER_VERSION:-1.6.1}
VAGRANT_VERSION=${VAGRANT_VERSION:-2.2.9}
VAULT_VERSION=${VAULT_VERSION:-1.5.0}
HELM_VERSION=${HELM_VERSION:-3.3.0}
EKSCTL_VERSION=${EKSCTL_VERSION:-0.25.0}
AWS_IAM_AUTH_VERSION=${AWS_IAM_AUTH_VERSION:-0.5.1}
KIND_VERSION=${KIND_VERSION:-0.8.1}
K9S_VERSION=${K9S_VERSION:-0.21.7}
