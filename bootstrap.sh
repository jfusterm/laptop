...
HUB_VERSION=${HUB_VERSION:-2.13.0}
TERRAFORM_VERSION=${TERRAFORM_VERSION:-0.12.15}
PACKER_VERSION=${PACKER_VERSION:-1.4.5}
VAGRANT_VERSION=${VAGRANT_VERSION:-2.2.6}
VAULT_VERSION=${VAULT_VERSION:-1.3.0}
HELM_VERSION=${HELM_VERSION:-3.0.0}
EKSCTL_VERSION=${EKSCTL_VERSION:-0.9.0}
