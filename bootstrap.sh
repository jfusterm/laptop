...
# Default versions
GO_VERSION=${GO_VERSION:-1.15.7}
BAT_VERSION=${BAT_VERSION:-0.17.1}
HUB_VERSION=${HUB_VERSION:-2.14.2}
TERRAFORM_VERSION=${TERRAFORM_VERSION:-0.14.5}
PACKER_VERSION=${PACKER_VERSION:-1.6.6}
VAGRANT_VERSION=${VAGRANT_VERSION:-2.2.14}
VAULT_VERSION=${VAULT_VERSION:-1.6.2}
HELM_VERSION=${HELM_VERSION:-3.5.1}
EKSCTL_VERSION=${EKSCTL_VERSION:-0.37.0}
AWS_IAM_AUTH_VERSION=${AWS_IAM_AUTH_VERSION:-0.5.2}
KIND_VERSION=${KIND_VERSION:-0.10.0}
K9S_VERSION=${K9S_VERSION:-0.24.2}
