...
BAT_VERSION=${BAT_VERSION:-0.15.0}
HUB_VERSION=${HUB_VERSION:-2.14.2}
TERRAFORM_VERSION=${TERRAFORM_VERSION:-0.12.24}
PACKER_VERSION=${PACKER_VERSION:-1.5.5}
VAGRANT_VERSION=${VAGRANT_VERSION:-2.2.7}
VAULT_VERSION=${VAULT_VERSION:-1.4.0}
HELM_VERSION=${HELM_VERSION:-3.2.0}
EKSCTL_VERSION=${EKSCTL_VERSION:-0.18.0}
AWS_IAM_AUTH_VERSION=${AWS_IAM_AUTH_VERSION:-0.5.0}
KIND_VERSION=${KIND_VERSION:-0.7.0}
K9S_VERSION=${K9S_VERSION:-0.19.3}
