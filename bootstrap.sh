...
# Default versions
GO_VERSION=${GO_VERSION:-1.13.6}
BAT_VERSION=${BAT_VERSION:-0.12.1}
HUB_VERSION=${HUB_VERSION:-2.13.0}
TERRAFORM_VERSION=${TERRAFORM_VERSION:-0.12.19}
PACKER_VERSION=${PACKER_VERSION:-1.5.1}
VAGRANT_VERSION=${VAGRANT_VERSION:-2.2.6}
VAULT_VERSION=${VAULT_VERSION:-1.3.1}
HELM_VERSION=${HELM_VERSION:-3.0.2}
EKSCTL_VERSION=${EKSCTL_VERSION:-0.12.0}
